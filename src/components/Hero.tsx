                        ...
                        <div className="flex-1 max-w-2xl">
                            ...
                            <div className="mb-12">
                                <p className="text-lg md:text-xl lg:text-2xl font-medium leading-relaxed mb-4">
                                    Join the ultimate <span className="font-black">web3 doodle</span> battle where
                                    <span className="font-black"> creativity meets crypto</span>. Draw, compete, and
                                    <span className="font-black"> earn rewards</span> on the blockchain!
                                </p>
                                <p className="text-base md:text-lg text-gray-600">
                                    Top 3 players win prizes. Connect your wallet and start drawing to earn!
                                </p>
                            </div>
