    ...
    <div className="flex flex-col items-center justify-center h-screen gap-8 bg-white">
      ...
      {!username ? (
        <form
          ...
          className="flex flex-col gap-6 bg-white border-2 border-black p-10 rounded-2xl shadow-xl w-80"
        >
          <input
          ...
          />
          <button
            className="bg-black hover:bg-gray-800 px-6 py-3 rounded-full text-white text-lg font-bold uppercase transition"
            type="submit"
            disabled={!name.trim()}
          >
            Continue
        ...
        <div className="flex flex-col gap-6 bg-white border-2 border-black p-10 rounded-2xl shadow-xl w-80">
          ...
          <form onSubmit={handleJoin} className="flex flex-col gap-3">
            ...
            />
            <button
              className="border-2 border-black hover:bg-black hover:text-white px-6 py-3 rounded-full text-black text-lg font-bold uppercase transition bg-white"
              type="submit"
          ...
          {error && (
            <div className="text-red-600 text-center mt-2 font-bold">
              {error}
            </div>
          )}
        </div>
